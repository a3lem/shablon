...
The system SHALL write each rendered template to the path obtained by joining the resolved working directory with the template's path relative to `.shablon/templates/`.
